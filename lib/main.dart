...
import 'package:google_fonts/google_fonts.dart'; // ตรวจสอบว่า import แล้ว
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp( // ใช้ const หาก home เป็น const
      debugShowCheckedModeBanner: false, // ทางเลือก: ซ่อน debug banner
      ...
      body: Padding( // Padding รอบเนื้อหาหลัก
        ...
        child: Column( // Column เลย์เอาต์หลัก
          ...
          children: <Widget>[
            ...
            // Asset Image
            Image.asset( 
              'assets/pheladii-portrait-10394259.jpg', // ตรวจสอบว่าพาธนี้ถูกต้องและประกาศใน pubspec.yaml
              height: 100,
              errorBuilder: (context, error, stackTrace) {
